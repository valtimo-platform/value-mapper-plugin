...
@Component({
    selector: 'valtimo-value-mapper-add-edit-modal',
    templateUrl: './value-mapper-add-edit-modal.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ValueMapperAddEditModalComponent implements OnInit {
    @Input() open = false;
